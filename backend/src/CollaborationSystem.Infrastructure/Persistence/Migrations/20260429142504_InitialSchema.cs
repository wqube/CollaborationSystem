        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DomainLogin = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drafts_Comments_ParentCommentId",
                        column: x => x.ParentCommentId,
                        principalSchema: "public",
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Drafts_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalSchema: "public",
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Drafts_Suggestions_SuggestionId",
                        column: x => x.SuggestionId,
                        principalSchema: "public",
                        principalTable: "Suggestions",
                        principalColumn: "Id");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Test User", "TBANK\\test.user", "test@test.local", "DEV_PASSWORD_HASH", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Admin User", "TBANK\\admin.user", "admin@test.local", "DEV_PASSWORD_HASH", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drafts_ParentCommentId",
                schema: "public",
                table: "Drafts",
                column: "ParentCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Drafts_ProjectId",
                schema: "public",
                table: "Drafts",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Drafts_SuggestionId",
                schema: "public",
                table: "Drafts",
                column: "SuggestionId");
